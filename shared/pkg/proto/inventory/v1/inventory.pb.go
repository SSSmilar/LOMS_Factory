...
const (
	PartType_PART_TYPE_UNSPECIFIED PartType = 0 //Не указан
	PartType_PART_TYPE_HULL        PartType = 1 //Корпус корабля
	PartType_PART_TYPE_ENGINE      PartType = 2 //Двигатель
	PartType_PART_TYPE_SHIELD      PartType = 3 // Защитный щит
	PartType_PART_TYPE_WEAPON      PartType = 4 //Вооружение
)
...
// Ответ на запрос о получение детали
...
type ListPartsRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PartType      PartType               `protobuf:"varint,1,opt,name=partType,proto3,enum=inventory.v1.PartType" json:"partType,omitempty"` // Фильтр по типу (UNSPECIFIED = все детали)
...
const file_inventory_v1_inventory_proto_rawDesc = "" +
	...
	"\x10ListPartsRequest\x122\n" +
	"\bpartType\x18\x01 \x01(\x0e2\x16.inventory.v1.PartTypeR\bpartType\x12\x14\n" +
	...
	"\tListParts\x12\x1e.inventory.v1.ListPartsRequest\x1a\x1f.inventory.v1.ListPartsResponseBLZJgithub.com/SSSmilar/LOMS_Factory/shared/pkg/proto/inventory/v1;inventoryv1b\x06proto3"
...
var file_inventory_v1_inventory_proto_depIdxs = []int32{
	...
	0, // 3: inventory.v1.ListPartsRequest.partType:type_name -> inventory.v1.PartType
